...
export class MongoModel {
    ...
    patch (query = {}, $addToSet = {}, callback) {
        this.MongooseModel.updateOne(query, { $addToSet }, { multi: true }, callback)
    }

    deleteElement (query = {}, $pull = {}, callback) {
        this.MongooseModel.updateOne(query, { $pull }, { multi: true }, callback)
    }
}